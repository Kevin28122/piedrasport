                ...
                <div class="card-body">
                    ...
                    <div class="card border-0">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-5">
                                <form id="insertForm" action="../../controllers/ProveedorController.php" method="post">
                                        <div class="mb-3">
                                            <input type="hidden" name="setProveedor" value="1">
                                        ...
                                        <button class="btn btn-primary" onclick="window.location.href = 'Reporte_prov.php';">Reporte</button>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="updateForm" action="../../controllers/ProveedorController.php" method="post">
                    <input type="hidden" name="updateProveedor" value="1">
                    <div class="mb-3">
...
<div class="modal fade" id="deleteModal" tabindex="-1" aria-labelledby="deleteModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                <form id="deleteForm" action="../../controllers/ProveedorController.php" method="post">
                <input type="hidden" name="deleteProveedor" value="1">
                        <div class="mb-3">
