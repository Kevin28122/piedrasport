                ...
                <div class="card-body">
                    ...
                    <div class="card border-0">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-5">
                                <form id="insertForm" action="../../controllers/ClienteController.php" method="post">
                                        <div class="mb-3">
                                            <input type="hidden" name="setCliente" value="1">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="Direccion_cliente" name="direccion" required>
                                        </div>
                                        <div class="mb-3">
                                            <label for="Email_cliente" class="form-label">Email</label>
                                            <input type="text" class="form-control" id="Email_cliente" name="email" required>
                                        </div>
                                        <div class="mb-3">
                                        ...
                                        <button class="btn btn-primary" onclick="window.location.href = 'Reporte_clien.php';">Reporte</button>
                                    </form>
                                </div>
                                <div class="col-md-6">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="updateForm" action="../../controllers/ClienteController.php" method="post">
                    <input type="hidden" name="updateCliente" value="1">
                    <div class="mb-3">
                        <label for="updateId" class="form-label">ID</label>
                        <input type="text" class="form-control" name="id" id="updateId" required>
                    </div>
                    <div class="mb-3">
                        <label for="updateNombrecliente" class="form-label">Nombre</label>
                        <input type="text" class="form-control" name="nombre" id="updateNombrecliente" required>
                    </div>
                    <div class="mb-3">
                        <label for="updateApellidocliente" class="form-label">Apellido</label>
                        <input type="text" class="form-control" name="apellido" id="updateApellidocliente" required>
                    </div>
                    <div class="mb-3">
                        <label for="updateDireccioncliente" class="form-label">Direccion</label>
                        <input type="text" class="form-control" name="direccion" id="updateDireccioncliente" required>
                    </div>
                    <div class="mb-3">
                        <label for="updateEmailcliente" class="form-label">Email</label>
                        <input type="text" class="form-control" name="email" id="updateEmailcliente" required>
                    </div>
                    <div class="mb-3">
...
<div class="modal fade" id="deleteModal" tabindex="-1" aria-labelledby="deleteModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                <form id="deleteForm" action="../../controllers/ClienteController.php" method="post">
                <input type="hidden" name="deleteCliente" value="1">
                        <div class="mb-3">
