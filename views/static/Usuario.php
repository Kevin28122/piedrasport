                ...
                <div class="card-body">
                    ...
                    <div class="card border-0">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-5">
                                    <form id="insertForm" action="../../controllers/UsuarioController.php" method="post">
                                        <div class="mb-3">
                                            <input type="hidden" name="setUsuario" value="1">
                                            <label for="Nombre" class="form-label">Nombre</label>
                                            <input type="text" class="form-control" id="Nombre" name="nombre" required>
                                        </div>
                                        <div class="mb-3">
                                            <label for="Contraseña" class="form-label">Email</label>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="password" class="form-control" id="Rol" name="rol" required>
                                        </div>
                                        <button type="submit" class="btn btn-primary">Insertar</button>
                                        <button class="btn btn-primary" onclick="window.location.href = 'Reporte_usu.php';">Reporte</button>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="updateModalLabel">Actualizar Usuaruo</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
            <form id="updateForm" action="../../controllers/UsuarioController.php" method="post">
                <div class="mb-3">
                    <input type="hidden" name="updateUsuario" value="1">
                    <label for="updateUsuario" class="form-label">Nombre</label>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="contraseña" id="updateContraseña" required>
                </div>
...
<div class="modal fade" id="deleteModal" tabindex="-1" aria-labelledby="deleteModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                <form id="deleteForm" action="../../controllers/UsuarioController.php" method="post">
                <input type="hidden" name="deleteUsuario" value="1">
                        <div class="mb-3">
                            <p>¿Estás seguro de que deseas eliminar este registro?</p>
                            <label for="deleteid" class="form-label">Nombre</label>
                            <input type="text" class="form-control" name="Nombre" id="deleteNombre" required>
                        </div>
